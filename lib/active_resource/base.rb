...
require 'active_resource/request_scope'
require 'active_resource/base/resource_class_methods'
require 'active_resource/base/base_class_methods'
require 'active_resource/base/base_instance_methods'
...
module ActiveResource
  ...
  class Base
    ...
    extend ActiveResource::BaseClassMethods
    include ActiveResource::BaseInstanceMethods
